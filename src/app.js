    ...
    <div class="modal">
      ...
      <div class="modal-body">
        ...
        ${esResponsableHSE() ? (()=>{
          ...
          return `
        <div class="section-title" style="margin-top:16px;padding-top:10px;border-top:2px solid var(--orange);">Gestión HSE — Cierre definitivo (Responsable)</div>
        ${ habilita ? `
...
async function printRecordPdf(id){
  ...
  body += `
    ...
    <table style="width:100%;border-collapse:collapse;margin-bottom:10px;">
      ${metaRow({l:'Severidad', v:(r.severidad||'Sin asignar')}, {l:'Estado de cierre', v: cerrado ? 'CERRADO (definitivo)' : 'Abierto / pendiente'})}
    </table>`;
  if(cerrado){
    body += `
